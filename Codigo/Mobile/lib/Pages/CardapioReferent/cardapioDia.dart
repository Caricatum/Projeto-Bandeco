...
class CardapioAlunoPage extends StatefulWidget {
  const CardapioAlunoPage({super.key, required this.usuario});

  final Usuario usuario;

  @override
  State<CardapioAlunoPage> createState() => _CardapioAlunoPageState();
}

class _CardapioAlunoPageState extends State<CardapioAlunoPage> {
