  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Botão rápido caso queira ir para a tela de cadastro
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                // Atualiza a tela ao voltar do cadastro
                setState(() {});
              });
            },
          ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: prato['imagem'] != null && prato['imagem'].toString().isNotEmpty
                          ? Image.network(
                              prato['imagem'],
                              height: 180,
                          ...
                          : const SizedBox(
                              height: 150,
                              child: Center(child: Icon(Icons.restaurant, size: 50)),
                            ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(12),
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          // Selo/Badge se for Vegano (opcional baseado na API)
