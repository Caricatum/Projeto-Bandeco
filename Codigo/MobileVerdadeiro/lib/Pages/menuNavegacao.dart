...
import 'CardapioReferent/cardapioDia.dart';
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => CardapioPage(usuario: usuario),
                ),
              );
            },
          ),
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CadastraCardapio(usuario: usuario),
                  ),
                );
              },
            ),
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => CardapioMostra(usuario: usuario),
                ),
              );
            },
          ),
