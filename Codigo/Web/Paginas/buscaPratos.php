...
<head>
    ...
    <style>
        ...
        .btn-like:hover, .btn-like.ativo {
            border-color: #2563eb;
            color: #2563eb;
            background: #eff6ff;
        }
        .btn-like.ativo { font-weight: bold; }
        ...
        .btn-fav:hover, .btn-fav.ativo {
            border-color: #d97706;
            color: #d97706;
            background: #fffbeb;
        }
        .btn-fav.ativo { font-weight: bold; }

        #filtros { gap: 10px; flex-wrap: wrap; }
        .spinner-area { min-height: 200px; display: flex; align-items: center; justify-content: center; }
        ...
        .estrela:hover, .estrela.selecionada { color: #f59e0b; }
    </style>
</head>
<body>
...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <button id="btnNovoCardapio" class="btn btn-success d-none" data-bs-toggle="modal" data-bs-target="#modalCadastrarCardapio">
                + Cardápio do Dia
            </button>
